...
//IMPORT COMPONETS
 ...
 const TechnologyContributionElement = () => {
                                ...
                                <div className="card mb-4">
                                    <div className="card-body">
                                        <div className="card-header">     
                                            <h5 className="card-title" style={{ color: 'blue' }}><b>Contribute For OSS</b></h5>
                                        </div>
                                        ...
                                        <Form onSubmit={props.handleSubmit}>
                                            ...
                                            <Form.Row>
                                                ...
                                                <CustomTextInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.paymentOption} placeholder="Enter Payment Option" label="Payment Option" name="paymentOption"/>
                                            
                                            </Form.Row>

                                           
                                            <Button variant="primary" type="submit">
                                                {props.isSubmitting ? 'Submit Payment Option...' : 'Submit Payment Option'}
                                            </Button>
                                        </Form>
