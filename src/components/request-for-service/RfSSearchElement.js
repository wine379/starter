                                    ...
                                    <div className="card-body">
                                        ...
                                        <Form onSubmit={props.handleSubmit}>
                                            <Form.Row>
                                                ...
                                                <CustomSelectInput label="City Area" name="area">
                                                    <AreaSelection />
                                                </CustomSelectInput>
                                            ...
                                            <Form.Row>
                                                ...
                                                <CustomTextInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.plotNo} placeholder="Enter Plot Number" label="Plot number" name="plotNo"/>
                                                <CustomTextInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.hhRefNo} placeholder="Enter HH Ref Number" label="HH Ref No." name="hhRefNo"/>
                                            </Form.Row>
...
export default RfSSearchElement
