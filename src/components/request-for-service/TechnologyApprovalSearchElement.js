...
//IMPORT COMPONETS
 ...
 const TechnologyApprovalSearchElement = () => {
                                ...
                                <div className="card mb-4">
                                    <div className="card-body">
                                        <div className="card-header">     
                                            <h5 className="card-title" style={{ color: 'blue' }}><b>Beneficiary Technology Approvals</b></h5>
                                        </div>
                                        ...
                                        <Form onSubmit={props.handleSubmit}>
                                            ...
                                            <Form.Row>    
                                                ...
                                                <CustomTextInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.technologyChoice} placeholder="Enter Technology Choice" label="Technology Choice" name="technologyChoice"/>
...
export default TechnologyApprovalSearchElement
