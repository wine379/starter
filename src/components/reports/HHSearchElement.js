                                    ...
                                    <div className="card-body">
                                        ...
                                        <Form onSubmit={props.handleSubmit}>
                                            <Form.Row>
                                                ...
                                                <CustomTextInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.hhCode} placeholder="Enter Household Code" label="Household Code" name="hhCode"/>
