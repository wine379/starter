...
import CustomSelectWithProps from '../_common/CustomSelectWithProps';
 ...
 const BasicLivelihoodCBDRATOTRegistrationElement = () => {
                                        ...
                                        <Form onSubmit={props.handleSubmit}>
                                            <Form.Row>
                                                <CustomSelectInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.ward} label="Training Type" name="training">
                                                        <CustomSelectWithProps elements={["DRM-TOT",  "Safeguards-TOT", "Climate Smart-TOT", "DRM -DRM Committee",]} />
                                                </CustomSelectInput>
                                            ...
                                            <Form.Row>
                                                <CustomSelectInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.ward} label="Target Audiance" name="sectorCommittee">
                                                        ...
                                                        elements={["Case Worker", "DRM Committee", "Lead Farmer", "Safeguard Committee",
                                                        ]} />
                                                </CustomSelectInput>
...
export default BasicLivelihoodCBDRATOTRegistrationElement;
