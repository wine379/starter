...
import CustomSelectWithProps from '../_common/CustomSelectWithProps';
 ...
 const BasicLivelihoodCBDRASearchElement = () => {
                                        ...
                                        <Form onSubmit={props.handleSubmit}>
                                            ...
                                            <Form.Row>
                                                ...
                                                <CustomSelectInput onBlur={props.handleBlur} onChange={props.handleChange} value={props.values.ward} label="Type Of Place" name="placeType">
                                                        <CustomSelectWithProps elements={["Forest Presevation", "Forest Firewall", "River Bank Preservation", "Road Reserve"
                                                        ]} />
                                                </CustomSelectInput>
                                            </Form.Row>
...
export default BasicLivelihoodCBDRASearchElement;
